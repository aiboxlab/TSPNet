...
def main(args):
    ...
    # we need to provide the following args:
    #    (1) destdir: destination directory of the created dictionaries
    #    (2) trainpref: prefix of train split; e.g. examples/translation/iwslt14.tokenized.de-en/train
    #    (3) validpref: prefix of valid split;
    #    (4) testpref: prefix of test split.
