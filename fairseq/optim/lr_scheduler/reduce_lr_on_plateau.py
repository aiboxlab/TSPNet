...
class ReduceLROnPlateau(FairseqLRScheduler):
    ...
    def __init__(self, args, optimizer):
        ...
        self.lr_scheduler = torch.optim.lr_scheduler.ReduceLROnPlateau(
            ...
            threshold=args.lr_threshold, mode=args.lr_mode)
    ...
    def add_args(parser):
        ...
        parser.add_argument('--lr-patience', default=10, type=int,
                            help='number of epochs before shrinking lr.')
        parser.add_argument('--lr-mode', default='min', type=str,
                            help='One of min, max. In min mode, lr will be reduced when the quantity '
