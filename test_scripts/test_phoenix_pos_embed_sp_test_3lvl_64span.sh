...
python test_scripts/test_sign_local.py data-bin/phoenix2014T/sp${VOCAB} \
        ...
        --max-tokens 4096 \
        --num-levels 3 \
        --multilv-args '{"span_lengths": [16, 32, 64], "level_links": [[1, 0], [2, 1], [2, 0]], "stride": 2, "eye": true, "same_level_links": true, "symmetric": true}' \
        --src-lv0-body-feat-root i3d-features/span=16_stride=2 \
        --src-lv1-body-feat-root i3d-features/span=32_stride=2 \
        --src-lv2-body-feat-root i3d-features/span=64_stride=2 \
